...
Lab threshold (eGFR > 60.0): 0 patient(s) — none in this cohort.
...
**Response:**
3 patient(s) have copd diagnosis but no documented spirometry documented: Mason Lewis, Mia Scott, Lincoln Gray.

Patients with 'copd diagnosis' (3 found): Mason Lewis, Mia Scott, Lincoln Gray.
'documented spirometry' is not recorded for any patient in this cohort — this observation type may not be in the structured database.
Age filter applied: patients over 65 only.

**SQL / Query description:** `Absence check: cond=['copd diagnosis', 'copd'], obs_absent=['documented spirometry'], date=None`
...
**Response:**
0 patients have 'diabetic' documented in this cohort's EHR. Stratification by glycaemic control cannot be performed.
...
**Error:** HTTP 500: {"detail":"Population query failed: 'NoneType' object is not iterable"}
...
Excluded condition ('opioid use disorder'): 0 patients have this — no exclusions applied.

**SQL / Query description:** `Condition present=['prescribed opioids'], absent=['opioid use disorder']`
...
Required condition ('diabetic patients'): 0 patients — not documented in this cohort's EHR.
Excluded by ('statin'): 1 patient(s) have this — Amelia Parker.
...
No patients have 'hospitalised' documented in this cohort's EHR.
  (ES semantic search also tried related terms — condition is not present in this dataset.)
'primary care follow-up' is not recorded for any patient in this cohort — this observation type may not be in the structured database.
