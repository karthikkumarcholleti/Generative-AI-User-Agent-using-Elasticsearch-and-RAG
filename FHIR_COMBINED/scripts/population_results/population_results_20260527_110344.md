...
**SQL / Query description:** `Absence check: cond=['hospitalisation in the past year'], obs_absent=['primary care follow-up within 30 days of discharge'], date=>= DATE_SUB(NOW(), INTERVAL 30 DAY)`
