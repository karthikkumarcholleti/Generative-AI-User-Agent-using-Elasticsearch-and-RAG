...
**SQL / Query description:** `Condition present=['Type II Diabetes'], absent=['elevated HbA1c', 'fasting glucose']`
...
Excluded condition ('opioid prescription duration < 90 consecutive days'): 0 patients have this — no exclusions applied.

**SQL / Query description:** `Condition present=['opioids'], absent=['opioid prescription duration < 90 consecutive days']`
...
'statin prescription or statin administration' is not recorded for any patient in this cohort — this observation type may not be in the structured database.

**SQL / Query description:** `Absence check: cond=['diabetic patients'], obs_absent=['statin prescription or statin administration'], date=None`
